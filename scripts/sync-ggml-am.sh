...
if [ -f $SRC_LLAMA/ggml-src.patch ]; then
    ...
    # src/ggml-block-interleaved.c      -> ggml/src/ggml-block-interleaved.c
    # src/ggml-block-interleaved.h      -> ggml/src/ggml-block-interleaved.h
    ...
    cat ggml-src.patch | sed -E \
        ...
        -e 's/([[:space:]]|[ab]\/)src\/ggml-block-interleaved\.c/\1ggml\/src\/ggml-block-interleaved.c/g' \
        -e 's/([[:space:]]|[ab]\/)src\/ggml-block-interleaved\.h/\1ggml\/src\/ggml-block-interleaved.h/g' \
